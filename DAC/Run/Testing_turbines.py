...
layout_x = turbs_layout_x # + dacs_layout_x
layout_y = turbs_layout_y # + dacs_layout_y 
type_defs = turbs_all # + dacs_all 

# Assign and check again
# might need to include reinitialized wind info here too
fmodel.reinitialize(layout_x=layout_x, layout_y=layout_y, turbine_type=type_defs, reference_wind_height= 90)
